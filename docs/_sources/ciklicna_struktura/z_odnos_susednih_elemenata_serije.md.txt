...
вредност, обрађујемо претходну и текућу вредност и након тога текућу вредност
...
Пошто није неопходно учитати све елементе серије, чим установимо да низ није
...
Решење задатка комбинује алгоритам одређивања серије цифара броја сдесна налево
...
се извршавање петље и мења се вредност помоћне променљиве на `0` јер цифре нису
...
Потребно је проверити да ли у серији датума постоји неки који не долази после њему
...
Ово је још један од задатака у којима се проверава однос суседних елемената.
