...
(низ бројева у коме је количник сваког члана и њему претходног константан) и да
је у овом задатку потребно одредити његов $n$-ти члан.
...
У језику C степен броја се може израчунати функцијом `pow` декларисаној у
заглављу `math.h`.
