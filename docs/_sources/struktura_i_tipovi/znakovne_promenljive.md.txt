...
Напиши програм у програмском језику C у којем су декларисане две знаковне
променљиве `t` и `v`.
...
касније му доделити вредност. Такође, дефинисаним константним подацима није
...
оне ће бити смештене у меморијску локацију величине 4 бајта. То значи да се
...
препроцесорским директивама `#if defined()`, `#else` и `#endif`, исто као и у
