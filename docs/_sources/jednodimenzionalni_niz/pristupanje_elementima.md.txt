...
па испиује вредност другог елемента низа `arr`.
...
стандарднog излазa исписује све унете оцене. Нека ограничење $0<n\le{20}$
...
меморијска локација није само неицијализована, него ни не припада низу `arr`.
