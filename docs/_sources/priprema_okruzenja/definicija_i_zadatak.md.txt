...
1. **Декомпозиција**: разлагање проблема на мање проблеме истог типа које је
једноставније решити.
...
* **Одређеност** (детерминистичност): алгоритамски поступак рашчлањен је на
