...
`Extensions` или притисни на тастатури `CTRL`, `SHIFT` и `X`. У поље за
...
За инсталацију MinGW користи се [MSYS2](https://www.msys2.org/) инсталер.
...
`pacman -Syu` па притисни `ENTER`. Процес ће изгледати отприлике овако:
