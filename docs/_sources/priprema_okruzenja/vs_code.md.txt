...
Након инсталације едитора, неопходно је да инсталираш C компајлер и дебагер.
GNU колекција компајлера и алата за Windows дистрибуира се кроз Cygwin и MinGW
пројекте, па ћеш у овој лекцији научити да инсталираш пакет mingw-w64 који
подржава програмирање у програмском језику C на 32-битним и 64-битним верзијама
