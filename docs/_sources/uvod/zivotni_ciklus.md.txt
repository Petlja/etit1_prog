...
(енгл. *Waterfall Model*). Иако је модел водопада дефинисан 1970. године, њега
можеш применити и данас на једноставним задацима. Модел је дефинисан кроз седам
фаза, где се са једне фазе прелази на другу, тек када је фаза у потпуности
завршена.
