...
интервалу, али идући здесна од интервала $[100,\infty)$.
...
Коначна цена се добија одузимањем добијеног износа попуста од цене школарине.
...
Задатак може да се реши и употребом конструкције `else-if`, поређењем броја
