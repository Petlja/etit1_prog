...
Може се десити да ти приликом решавања неког задатка не треба променљива за
...
а модификатором `unsigned` *(срп. неозначен)* да нема тј. да је увек
позитиван. Коришћењем модификатора `unsigned` ослобађа се бит који се чува за
знак, чиме се повећава опсег вредности које променљива може да добије, па тако,
...
Модификатори `signed` и `unsigned` могу се комбиновати са модификаторима
...
позитивне вредности, што значи да је означен, па се променљива типа `int` може
...
или реалан број - препроцесор ће сâм одредити о ком типу податка је реч.
...
након тога, дефиниши константни целобројни податак `c` и додели му вредност
