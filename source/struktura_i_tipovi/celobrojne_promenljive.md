...
`int`. На пример, нека је задатак да напишеш програм у програмском језику C у
којем ће бити декларисане три целобројне променљиве `x`, `y` и `z`. Програм
можеш написати на следећи начин:
...
На пример, Алиса, Боб, Цеца и Дуле на данашњи дан имају редом 16, 17, 14 и 15
година. Напиши програм у програмском језику C у којем ћеш иницијализовати
променљиве `a`, `b`, `c` и `d` са тренутним бројем година које Алиса, Боб, Цеца
и Дуле имају на данашњи дан:
...
int main(void)
{
    int a = 16, b = 17, c = 15, d = 18;
    return 0;
}
```

У истој линији можеш комбиновати и декларацију и иницијализацију. На пример,
ако су познате године Алисе, Боба, Цеце и Дулета као у претходном примеру, а
нису познате године Филипа и Горана, то можеш записати на следећи начин:
