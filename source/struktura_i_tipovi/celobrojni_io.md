...
вредности којима су иницијализоване целобројне променљиве `t = 16` и `v = 18`.
...
У оквиру једне `printf()` функције можеш користити више поља истовремено и
...
`lista_adresa` садржи адресе променљивих које се записују у облику
...
Једним позивом `scanf()` функције можеш унети више података истовремено.
