...
У овом задатку комбинује се одређивање максимума серије елемената (што радимо
...
посебне променљиве (по једна за поене из свака три предмета). У том случају учитавамо
...
координата тачака се наставља и одређује се њиховим растојањем од координатног
